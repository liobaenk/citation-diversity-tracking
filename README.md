...
Post-processing and visualising output from cleanBib (https://github.com/dalejn/cleanBib), a toolbox that utilises https://gender-api.com.
...
+ (1) Why should I track or even report my citation diversity in my manuscript/paper? #tba
